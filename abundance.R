...
#' S_abundance(data, knots = 20) for abundance data, estimates the diversity and species composition of mixed assemblage consisting of various portions of two assemblages.  
...
S_abundance <- function(data1, knots = 10){
  x1 = data1[, 1]
  x2 = data1[, 2]
  n1 = sum(x1)
  n2 = sum(x2)
